 ...
 */
      ...
      function reFhjtjFlash(){
         //reload:重新执行url，condition是url中的参数  
            $("#searchFhjtjFm").form("clear");  
           // $("#FhjtjDg").datagrid("reload");  
            $("#FhjtjDg").datagrid({
 	           url:"showFhj/list.action"      	     
 	         }); 
        
        }
      function doFhjtjWeekSearch(){
	      $("#FhjtjDg").datagrid({
	...
	<body class="easyui-layout">
		<table id="FhjtjDg" title="分销奖统计列表" class="easyui-datagrid" style="width:1750px;height:865px"
			url="showFhj/list.action"
		...
		<div id="toolbar" style="padding:3px">			
		    <div style="padding:3px">
		        <form id="searchFhjtjFm">  									   
					...
					<a href="#" class="easyui-linkbutton" iconCls="icon-search"  onclick="doFhjtjSearch()">搜索</a>&nbsp;&nbsp;	
					<span>月份选择:</span>&nbsp;&nbsp;
					...
					<!-- <input id="month1" name="month1" style="line-height:18px;border:1px solid #95b9e7" class="easyui-combobox" data-options="    
                                ...
                                panelHeight:'auto'
                              "/>&nbsp;&nbsp;&nbsp;&nbsp;  -->
					<a href="#" class="easyui-linkbutton" iconCls="icon-search"  onclick="doFhjtjMonthSearch()">按月查询</a>&nbsp;&nbsp;	
					<a href="#" class="easyui-linkbutton" iconCls="icon-search"  onclick="doFhjtjWeekSearch()">本周查询</a>&nbsp;&nbsp;								
					<a href="#" class="easyui-linkbutton" iconCls="icon-reload"  onclick="reFhjtjFlash()">刷新(昨日)</a>
				 </form>
			</div>
		</div>       
