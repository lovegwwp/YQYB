     ...
     openMenuTow(node);  
		...
		function openMenuTow(node){
            ...
            if (exist_tab) {  
                ...
                if(noteText=="医生列表"){
                ...
                }else if(noteText=="代理人统计"){
                	content = '<iframe scrolling="auto" frameborder="0"  src="dlrType.action" style="width:100%;height:100%;"></iframe>';

                }else if(noteText=="代理人审核"){
                	content = '<iframe scrolling="auto" frameborder="0"  src="dlrAuth.action" style="width:100%;height:100%;"></iframe>';
                	...
                	window.parent.location.href='/YQYB/shiro-tcxt.action';
                }else{
